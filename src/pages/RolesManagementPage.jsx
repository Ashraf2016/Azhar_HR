...
const RolesManagementPage = () => {
  ...
  //   try {
  //     await axios.put(
  //       `https://university.roboeye-tec.com/roles/${selectedRole.id}/permissions`,
  //       {
  ...
  //     // // ✅ تحديث selectedRole بالـ permissions الجديدة
  ...
  //     setRolePermissions([...currentSet]); // ✅ خليه هو المصدر الأساسي


  //     // ✅ تحديث checkboxes فورًا
  //     const groupedPermissions = {};
